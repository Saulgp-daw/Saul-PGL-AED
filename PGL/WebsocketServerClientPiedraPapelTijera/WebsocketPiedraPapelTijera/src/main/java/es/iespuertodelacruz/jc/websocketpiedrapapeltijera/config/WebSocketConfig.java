...
import es.iespuertodelacruz.jc.websocketpiedrapapeltijera.security.JwtService;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
	...
	@Autowired private UsuarioEntityService usuarioservice;
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        ...
        registry.addEndpoint("/sockjs").setAllowedOriginPatterns("*")
        .withSockJS()
        ;
        ...
        registration.interceptors(new ChannelInterceptor() {
            ...
            public Message<?> preSend(Message<?> message, MessageChannel channel) {
                ...
                if (StompCommand.CONNECT.equals(accessor.getCommand())) {
                    ...
                    UsuarioEntity usuario = usuarioservice.findByName(username);
