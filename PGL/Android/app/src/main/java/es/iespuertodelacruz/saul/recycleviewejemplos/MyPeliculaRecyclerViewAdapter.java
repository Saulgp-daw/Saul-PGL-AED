...
import es.iespuertodelacruz.saul.recycleviewejemplos.placeholder.PlaceholderContent.PlaceholderItem;
import es.iespuertodelacruz.saul.recycleviewejemplos.databinding.FragmentPeliculaBinding;
...
public class MyPeliculaRecyclerViewAdapter extends RecyclerView.Adapter<MyPeliculaRecyclerViewAdapter.ViewHolder> {
    ...
    public MyPeliculaRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
