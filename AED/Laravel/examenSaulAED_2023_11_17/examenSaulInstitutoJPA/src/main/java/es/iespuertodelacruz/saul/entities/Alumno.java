...
@NamedQuery(name="Alumno.deleteByIdRel", query= "DELETE FROM Alumno WHERE dni = :dni")
@NamedQuery(name="Alumno.findBySubRel", query= "SELECT a FROM Alumno a where a.nombre LIKE %:nombre%")
